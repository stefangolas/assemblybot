...
- **Custom/generated parts are held to the SAME attachment-ontology standard as catalog parts — author their
  FULL ontology, in the CAD *and* the def.** Every real mounting hole, thread, pilot, counterbore, and seat must
...
**CLAUDE.md Hard Rule 6 extended this session:** custom/generated parts carry FULL attachment ontology (holes in
...
See CLAUDE.md §4b/§4c + [[misumi-cad-pipeline-and-discovery]].
